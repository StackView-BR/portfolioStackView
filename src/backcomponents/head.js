...
function Head({ title }) {
  return (
    <NextHead>
      ...
      <meta property="og:image" content="/ogp.png" key="image"/>
      ...
      <meta property="twitter:card" value="summary_large_image" key="card"/>
      <meta property="twitter:title" content="StackView - Desenvolvimento Full-Stack, Design, Engenharia" key="title" />
      <meta property="twitter:description" content="Automação, Iot e Full-Stack, Desenvolvimento Sistemas de controle e manutenção, Aplicativos, PWA, websites responsivos e gestão de dados" key="description" />
      <meta property="twitter:image" content="/ogp.png" key="image" />
